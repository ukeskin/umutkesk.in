...
The alert message may be dynamically injected into the DOM after form submission in many implementations. However, the screen reader might not announce the alert despite using aria-live, leaving users unaware of the validation errors.
 ...
 <iframe src="https://medium.com/media/2a98ac40101ebed96afb2f45e9eb341b" frameborder=0></iframe>
...
Here’s how you can define the alert as an aria-live region in code and demo video

> _Make web for everyone._

 <iframe src="https://medium.com/media/3fc2498c2d9a8bbc835a8f9e0c1ec0a9" frameborder=0></iframe>
[**CodePen Embed - aria-live**
*function validateForm(event) { event.preventDefault(); var nameInput = document.getElementById("name").value.trim(); if…*codepen.io](https://codepen.io/ukeskin/embed/ExJmLLL?default-tab=html%2Cresult)
